      ...
      <main>
        <Container size="narrow" className="py-14 sm:py-20 lg:py-24">
          <article>
            ...
            <div className="flex flex-col gap-12 pt-10 sm:pt-12 [&_a]:rounded-sm [&_a]:text-primary [&_a]:underline [&_a]:underline-offset-4 [&_a]:transition-colors hover:[&_a]:text-foreground [&_a]:focus-visible:outline-none [&_a]:focus-visible:ring-2 [&_a]:focus-visible:ring-ring [&_address]:not-italic [&_h2]:text-balance [&_h2]:font-serif [&_h2]:text-2xl [&_h2]:font-semibold [&_h2]:tracking-tight sm:[&_h2]:text-3xl [&_li]:leading-relaxed [&_p]:leading-relaxed [&_section]:flex [&_section]:scroll-mt-24 [&_section]:flex-col [&_section]:gap-4 [&_ul]:flex [&_ul]:list-disc [&_ul]:flex-col [&_ul]:gap-2 [&_ul]:pl-5">
              {children}
            </div>
          </article>
        </Container>
