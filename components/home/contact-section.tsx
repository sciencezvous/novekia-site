      ...
      <div className="relative">
        ...
        <div className="mt-10 grid grid-cols-1 gap-10 sm:mt-12 sm:gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <aside className="border-t border-border pt-8 lg:border-l lg:border-t-0 lg:pl-12 lg:pt-0" aria-labelledby="contact-info-title">
            <h3 id="contact-info-title" className="text-xl font-semibold text-foreground">Première prise de contact</h3>
            <p className="mt-4 max-w-xl text-sm leading-relaxed text-muted-foreground">
              Présentez votre contexte, vos contraintes principales et le résultat attendu. Novekia vous répondra avec une première qualification du besoin.
            </p>
